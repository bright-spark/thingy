...
const kLocalRoot = "https://localhost:8080/theradio.fm/";
...
const kOneSignalAppId="a3a7d462-757a-4451-b336-a9f2c5b0f0b2";
...
const kPhotoBrowserAutoPlay="autoplay: {delay: 1000},";
...
const kAddToHomeScreenMdText="Add the app to your home screen now to keep on listening for free!";
const kAddToHomeScreenIosText="Add the app to your home screen now to keep on listening for free!";
...
const kCache="no-cache"; //default, no-cache, reload, force-cache, only-if-cached
...
const kAuthorization="'Authorization': 'Basic theradio.fm'"; //'Authorization': 'Basic xxxxx'
